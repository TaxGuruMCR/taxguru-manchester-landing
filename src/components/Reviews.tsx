...
const Reviews = () => {
  ...
  return <section className="py-20 px-4 bg-gray-50" id="reviews">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">What Our Clients Say</h2>
          <p className="text-xl text-gray-600">Sure, you could take our word that we are the best accounting firm for you, but we figure we’ll let the reviews do the talking.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((review, index) => <Card key={index} className="hover:shadow-lg transition-all duration-300 bg-white">
